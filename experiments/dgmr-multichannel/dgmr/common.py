...
class ContextConditioningStack(torch.nn.Module, PyTorchModelHubMixin):
    def __init__(
        ...
        **kwargs
        ...
        self.conv1 = spectral_norm(
            conv2d(
                in_channels=(output_channels // 4) * _input_channels_mult,
                out_channels=(output_channels // 8) * _input_channels_mult,
                kernel_size=3,
                padding=1,
            )
        )
        ...
        self.conv2 = spectral_norm(
            conv2d(
                in_channels=(output_channels // 2) * _input_channels_mult,
                out_channels=(output_channels // 4) * _input_channels_mult,
                kernel_size=3,
                padding=1,
            )
        )
        ...
        self.conv3 = spectral_norm(
            conv2d(
                in_channels=output_channels * _input_channels_mult,
                out_channels=(output_channels // 2) * _input_channels_mult,
                kernel_size=3,
                padding=1,
            )
        )
        ...
        self.conv4 = spectral_norm(
            conv2d(
                in_channels=output_channels * 2 * _input_channels_mult,
                out_channels=output_channels * _input_channels_mult,
                kernel_size=3,
                padding=1,
            )
        )
    ...
    def forward(
        ...
        # # TODO: optimize by moving time to batch dim
        # scale_1 = torch.stack(
        #     scale_1, dim=1
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.l_block1 = LBlock(
            input_channels=shape[0], output_channels=output_channels // 16  # 32
        )
        self.l_block2 = LBlock(
            input_channels=output_channels // 16, output_channels=output_channels // 8
        )
        self.l_block3 = LBlock(
            input_channels=output_channels // 8, output_channels=output_channels // 2
        )
        ...
        self.l_block4 = LBlock(
            input_channels=output_channels // 2, output_channels=output_channels
        )
