...
# %%
ARCH = "efficientnetv2_xl"
BATCH_SIZE = 32
FORECAST = 24

wandb.init(project="climatehack", group=ARCH)
# %%
...
# %%
callbacks = [
    SaveModelCallback(monitor="train_loss", fname=ARCH),
    # ReduceLROnPlateau(monitor="train_loss"),
