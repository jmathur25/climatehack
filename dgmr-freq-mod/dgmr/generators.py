        ...
        **kwargs
        ...
        self.gru_conv_1x1 = spectral_norm(
            torch.nn.Conv2d(
                ...
                out_channels=output_channels,  # latent_channels
                kernel_size=(1, 1),
            )
        )
        self.g1 = GBlock(
            input_channels=output_channels,  # latent_channels
            output_channels=output_channels,  # latent_channels
        )
        self.up_g1 = UpsampleGBlock(
            input_channels=output_channels,  # latent_channels
            output_channels=output_channels // 2,  # latent_channels // 2
        )

        self.convGRU2 = ConvGRU(
            input_channels=output_channels // 2
            + context_channels // 2,  # latent_channels // 2 + context_channels // 2,
        ...
        self.gru_conv_1x1_2 = spectral_norm(
            torch.nn.Conv2d(
                ...
                out_channels=output_channels // 2,  # latent_channels // 2,
                kernel_size=(1, 1),
            )
        )
        self.g2 = GBlock(
            input_channels=output_channels // 2,  # latent_channels // 2
            output_channels=output_channels // 2,  # latent_channels // 2,
        )
